  ...
  return (
    <Card className="w-full">
      <div className="flex items-center gap-3 mb-6">
        <Clock className="text-primary-light w-8 h-8" />
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="time"
              className="w-full bg-bg-input border-none rounded-lg p-2 text-white"
        ...
        <button
          ...
          className="w-full bg-primary-dark hover:bg-primary text-white font-bold py-3 rounded-lg transition-colors mt-4"
        >
          生成調整計畫
        </button>
      </div>
