...
const SleepWarningDialog = ({ show, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-slate-800 border border-slate-700 rounded-2xl max-w-lg w-full shadow-2xl overflow-hidden my-8 relative">
        ...
        <div className="p-6 text-slate-300 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <ul className="space-y-4 mt-4">
            <li>
              <h4 className="font-bold text-red-400">🧠 腦部與認知功能受損</h4>
            ...
            <li>
              <h4 className="font-bold text-green-400">🛡️ 免疫力全面下降</h4>
              <p className="text-sm mt-1">
            ...
            <li>
              <h4 className="font-bold text-indigo-400">🧬 內分泌失調</h4>
              <p className="text-sm mt-1">
